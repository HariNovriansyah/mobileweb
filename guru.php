    ...
    <div class="col-md-12">
        ...
        elseif ($_GET['alert'] == 1) { ?>
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong><i class="fas fa-check-circle"></i> Sukses!</strong> Data guru berhasil disimpan.
        ...
        elseif ($_GET['alert'] == 2) { ?>
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong><i class="fas fa-check-circle"></i> Sukses!</strong> Data guru berhasil diubah.
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
        ...
        elseif ($_GET['alert'] == 3) { ?>
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong><i class="fas fa-check-circle"></i> Sukses!</strong> Data guru berhasil dihapus.
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
        ...
        elseif ($_GET['alert'] == 4) { ?>
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong><i class="fas fa-times-circle"></i> Gagal!</strong> nip <b><?php echo $_GET['nip']; ?></b>
                sudah ada.
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
        ...
        <form class="mr-3" action="index.php" method="post">
            <div class="form-row">
                <!-- form cari -->
                <div class="col-3">
                    <input type="text" class="form-control" name="cari" placeholder="Cari NIP atau Nama guru" value="<?php echo $cari; ?>">
                </div>
                <!-- tombol cari -->
                <div class="col-8">
                ...
                <!-- tombol tambah data -->
                <div class="col-1">
                    <a class="btn btn-info" href="?page=tambahg" role="button"><i class="fas fa-plus"></i>
                        Tambah</a>
                </div>
            </div>
        </form>
...
ORDER BY nip DESC LIMIT $mulai, $batas")
                ...
                while ($data = mysqli_fetch_assoc($query)) { ?>
                    <tr class="cap">
                        ...
                        <td width="45"><img class="foto-thumbnail" src='foto/<?php echo $data['foto']; ?>' alt="Foto Guru"></td>
                        <td width="80" class="center"><?php echo $data['nip']; ?></td>
                        <td width="180" class="center"><?php echo $data['nama']; ?></td>
                        <td width="190" class="center"><?php echo $data['tempat_lahir']; ?>, <?php echo date(
                                                                                                    'd-m-Y',
                                                                                                    strtotime($data['tanggal_lahir'])
                                                                                                ); ?></td>
                        <td width="130" class="center"><?php echo $data['jenis_kelamin']; ?></td>
                        <td width="100" class="center"><?php echo $data['status']; ?></td>
                        <td width="100" class="center"><?php echo $data['agama']; ?></td>
                        <td width="100" class="center"><?php echo $data['email']; ?></td>
                        <td width="70" class="center"><?php echo $data['no_hp']; ?></td>
                        <td width="120" class="center">
                            <a title="Ubah" class="btn btn-outline-success" href="?page=ubahg&nip=<?php echo $data['nip']; ?>"><i class="fas fa-edit"></i></a>
                            <a title="Hapus" class="btn btn-outline-danger" href="guruhapus.php?nip=<?php echo $data['nip']; ?>" onclick="return confirm('Anda yakin ingin menghapus guru <?php echo $data['nama']; ?>?');"><i class="fas fa-trash"></i></a>
                        </td>
                    </tr>
                <?php
                    $no++;

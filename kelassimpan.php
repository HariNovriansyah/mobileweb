<?php
    ...
    if (isset($_POST['simpan'])) {
        ...
        if ($rows > 0) {
            ...
            header("location: index.php?alert=4&kode_kelas=$kode_kelas");
        }
        // jika kode_kelas belum ada  
            ...
            // upload file
                ...
                $insert = mysqli_query($db, "INSERT INTO tbl_kelas(kode_kelas,nama_kelas,wali_kelas,tingkat,semester,tahun)
VALUES('$kode_kelas','$nama_kelas','$wali_kelas','$tingkat','$semester','$tahun')")

    ...
    <div class="row">
        <div class="col-md-12">
			  	...
			  	<div class="card-body">
			    	...
			    	<form class="needs-validation" action="kelasSimpan.php" method="post" enctype="multipart/form-data" novalidate>
						...
						<div class="form-group col-md-12 right">
			                <a href="index.php?page=kelasWaliTambah&kode_kelas=<?php echo $kode_kelas; ?>" class="btn btn-info">Tambah Siswa</a>
            ...
            <tbody>
            <?php
                $query = mysqli_query($db, "SELECT * FROM tbl_kelasdetail tkd INNER JOIN tbl_siswa ts ON ts.nis=tkd.nis ORDER BY ts.nis DESC")
            ...
            while ($data = mysqli_fetch_assoc($query)) { ?>
                <tr>
                    ...
                    <a title="Hapus" class="btn btn-outline-danger"
                            href="#?kode_kelas=<?php echo $data['kode_kelas']; ?>&nis=<?php echo $data['nis']; ?>"
                            onclick="return confirm('Anda yakin ingin menghapus Siswa <?php echo $data['nama']; ?>?');"><i

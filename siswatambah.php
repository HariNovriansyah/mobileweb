<div class="row">	
<div class="col-md-12">	<div class="alert alert-info" role="alert">	<i class="fas fa-edit"></i> Input Data Siswa	</div>		<div class="card">	<div class="card-body">	<!-- form tambah data siswa -->
	<form class="needs-validation" action="siswasimpan.php" method="post" enctype="multipart/form-data" novalidate>
	<div class="row">
	<div class="col">
	<div class="form-group col-md-12">
	<label>NIM</label>
	<input type="text" class="form-control" name="nis" maxlength="10" onKeyPress="return goodchars(event,this)" autocomplete="off" required>
...
<input type="text" class="form-control date-picker" data-date-format="dd-mm-yyyy" e="tanggal_lahir" autocomplete="off" required>
...
<a href="index.php" class="btn btn-secondary btn-reset"> <i class ='fa fa-times'></i>Batal </a>
</div>
</form>
</div>
</div>

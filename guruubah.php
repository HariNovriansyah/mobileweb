...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-body">
                <!-- form ubah data guru -->
                <form class="needs-validation" action="guruprosesubah.php" method="post" enctype="multipart/form-data" novalidate>
                    <div class="row">
                        <div class="col">
                            <div class="form-group col-md-12">
                                <label>NIP</label>
                                <input type="text" class="form-control" name="nip" maxlength="5" onKeyPress="return goodchars(event,'0123456789',this)" autocomplete="off" value="<?php echo $nip; ?>" readonly required>
                        ...
                        <div class="col">
                            <div class="form-group col-md-12">
                                ...
                                <div id="imagePreview"><img class="foto-preview mb-3" src="foto/<?php echo $foto; ?>" /></div>
